            ...
            <main class="male">
                ...
                <section class="shop">
                    <ul class="shop-categories">
                        ...
                        <li class="shop-category">Suits</li>
                        <li class="shop-category">Coorporate Shirt</li>
                        <li class="shop-category">Trousers</li>
                        <li class="shop-category">Jalabia</li>
                        <li class="shop-category">Vintage</li>
                        <li class="shop-category">Short</li>
                        <li class="shop-category">Shoes</li>
                    </ul>
